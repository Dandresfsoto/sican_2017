    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamentos', models.ManyToManyField(blank=True, related_name='departamento_lider', to='departamentos.Departamento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oculto', models.BooleanField(default=False)),
                ('archivo', models.FileField(blank=True, upload_to='Lideres/Soportes/')),
                ('lider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lideres.Lideres')),
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='soporte_lider', to='rh.TipoSoporte')),
            ],
            options={
                'ordering': ['lider'],
            },
