...
{% block subject %}
Respuesta REQ - {{ id_requerimiento }}
{% endblock %}
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy" style="text-align: justify; color: #153643; font-family: sans-serif;font-size: 16px; line-height: 22px;">
                Recurso humano respondio al requerimiento de consecutivo <a href="https://sican.asoandes.org/formacion/requerimientoscontratacion/"> REQ - {{ id_requerimiento }}</a>,
                  recuerda ponerte en contacto con el aspiante lo mas pronto posible.
              </td>
            </tr>
          </table>
        </td>
