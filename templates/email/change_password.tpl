          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="bodycopy" style="text-align: justify; color: #153643; font-family: sans-serif;font-size: 16px; line-height: 22px;">
                Se realizo un cambio de contraseña de la cuenta registrada en el sistema de información SICAN asociada
                  a este email, a continuacion se encuentran los nuevos datos de acceso.
              </td>
            </tr>
          </table>
        </td>
